...
void same_side_final(){
  ...
  move_new_deg(-500, 80, 50, 270, 0.4);
  // wait(1000, msec); //測試用wait
  move_turn(129, 0.55);
  intake.stop(brake);
...
void same_side_5final(){
  ...
  move_turn(241, 0.56);
  intake.spin(fwd, 600, rpm);
  move_new_deg(1100, 70, 40, 241, 0.35);
  TankMove(-50, 0);
  wait(340, msec);
  drivertrainStop(brake);
  TankMove(-20, -20);
  ...
  // wait(1000, msec); //測試用wait
  intake_piston.set(true);
  move_new_deg(1250, 60, 80, 180, 0.4);//280 uturn
  // wait(1000, msec); //測試用wait
  cata.spin(fwd, 50, rpm);
  move_turn(269, 0.5);
  intake_piston.set(false);
...
void diff_side_awp_middle(){
  ...
  // move_turn(222, 0.5);
  move_new_deg(2000, 60, 40, 222, 0.6);
  // wait(1000, msec); //測試用wait
  ...
  l_wing.set(true);
  wait(100, msec);
  move_new_deg(-400, 50, 30, 285, 0.5);
  // wait(1000, msec); //測試用wait
  wait(100, msec);
  l_wing.set(false);
  wait(100, msec);
  ...
  wait(100, msec);
  move_new_deg(-1550, 35, 40, 270, 0.3);
  // wait(10000000, msec); //測試用wait
  r_wing.set(true);
  // wait(1000, msec); //測試用wait
...
void diff_side_shoot_opp(){
  ...
  wait(100, msec);
  move_new_deg(-1200, 70, 40, 270, 0.3);
  
  wait(100, msec);
  move_new_deg(1950, 70, 40, 285, 0.4);
  // wait(1000, msec); //測試用wait
  move_turn(280, 0.5);
  TankMove(-17, -17);
  wait(200, msec);
...
void auto_skills(){
  ...
  move_new_deg(-4400, 90, 40, 180, 0.6); //轉彎到 1200
  // wait(1000000000, msec); //測試用wait
  cata.stop(coast);
  ...
  move_new_deg(-800, 80, 40, 17, 0.4);
  l_wing.set(true);
  move_new_deg(-600, 80, 40, 17, 0.4);
  // wait(1000, msec); //測試用wait
  // l_wing.set(false);
  ...
  move_new_deg(200, 70, 50, 180, 0.3);
  move_turn(0, 0.6);
  r_wing.set(true);
  ...
  move_new_deg(-800, 70, 40, 190, 0.3);
  TankMove(100, 100);
  wait(500, msec);
  drivertrainStop(brake);
  // wait(1000, msec); //測試用wait
  move_new_deg(1600, 70, 40, 200, 0.3);
  wait(1000, msec); //測試用wait

  move_turn(128, 0.5);
  // l_wing.set(true);
  r_wing.set(true);
  move_new_deg(-2200, 70, 40, 128, 0.3);
  r_wing.set(false);
  wait(1000, msec); //測試用wait
  ...
  // l_wing.set(false);
  wait(1000, msec); //測試用wait
  move_new_deg(-1000, 70, 60, 270, 0.37);
  TankMove(80, 80);
  wait(600, msec);
  drivertrainStop(brake);
  move_new_deg(400, 60, 40, 270, 0.4);
  TankMove(80, 80);
  wait(600, msec);
  drivertrainStop(brake);
