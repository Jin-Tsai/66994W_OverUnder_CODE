...
void diff_side_awp_middle(){
  ...
  // wait(1000, msec); //測試用wait
  l_wing.set(true);
  move_new_deg(-400, 70, 70, 285, 1.2);
  // wait(1000, msec); //測試用wait
  wait(100, msec);
  l_wing.set(false);
  ...
  wait(100, msec);
  move_new_deg(-1170, 30, 40, 270, 0.3);
  // wait(1000, msec); //測試用wait
  r_wing.set(true);
  // wait(1000, msec); //測試用wait
...
void auto_skills(){
  ...
  move_new_deg(-1700, 70, 40, 90, 0.92);
  ...
  // while(Brain.Timer.time(seconds)<45){
  ...
  move_new_deg(-1800, 80, 80, 89, 0.55);
  // wait(1000, msec); //測試用wait
